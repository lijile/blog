...
<html lang="en">
	...
	<body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <c:set var="thismenu" value="user_summary"/>
                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th>Username</th>
                                            <th>Fullname</th>
                                            <th class="hidden-480">Cellphone</th>
                                        ...
                                        <c:forEach items="${pager.result}" var="user">
                                            <tr>
	                                            ...
	                                            <td class="hidden-480">
	                                                ...
	                                                <span class="label label-sm label-warning">disable</span>
                                                    </c:if>
	                                            </td>
                                    ...
                                    <script type="text/javascript">
				                        ...
				                        pa.pageUrl = "${basePath}user/list.do" ;
				                        pa.pageSize = 10;
				                        pa.printPage() ;
				                    </script>
                                </div>
